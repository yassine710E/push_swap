...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/12/25 14:30:00 by ychabane          #+#    #+#             */
/*   Updated: 2025/12/25 14:31:00 by ychabane         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	swap_first_two(t_list **top, char *s_stack_op, int checker_flag)
{
	t_list	*tmp;
...
void	reverse_rotate(t_list **list, char *rr_stack_name, int checker_flag)
{
	t_list	*head;
	t_list	*tmp;
